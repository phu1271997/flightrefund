...
export default function App() {
  ...
  return (
    <main>
      ...
      <h1>FlightRefund</h1>
      <p className="tag">
        Parametric flight-delay coverage on GenLayer. Buy a policy against a specific flight.
        When the flight lands (or is cancelled), the Intelligent Contract fetches
        flightaware.com and flightradar24.com <em>directly on-chain</em>, has validator LLMs
        cross-check both sources, and only pays when they agree. No oracle, no insurer.
      </p>
